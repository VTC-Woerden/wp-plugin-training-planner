			...
			wp_localize_script(
				...
				array(
					...
					'i18n'   => array(
						...
						'saveException' => __( 'Opslaan', 'vtc-training-planner' ),
						...
						'dirtyBannerException' => __( 'Je hebt niet-opgeslagen wijzigingen. Klik op “Opslaan” om ze direct naar de live uitzonderingsweek te sturen.', 'vtc-training-planner' ),
						...
						'helpDrag'   => __( 'Sleep een team naar een baan (veld) op de tijdas om een training te plannen. Sleep blokken horizontaal om te verplaatsen; sleep de linkerrand om te beginnen, de rechterrand om de duur te wijzigen. Met Ctrl (⌘ op Mac) klik je meerdere blokken aan en verschuif je ze samen in de tijd. Gebruik de +-knop op een blok om een extra team op hetzelfde tijdsslot en veld toe te voegen (gezamenlijke training). Inhuurblokken bewerk je in modus “Zaal/veld (inhuur)”. Dubbelklik of × om te verwijderen. Wijzigingen blijven lokaal tot je op “Concept opslaan” drukt.', 'vtc-training-planner' ),
						'saved'      => __( 'Opgeslagen.', 'vtc-training-planner' ),
						'added'      => __( 'Training toegevoegd.', 'vtc-training-planner' ),
						'deleteSlot' => __( 'Verwijderen', 'vtc-training-planner' ),
						'addTeamToSlot' => __( 'Team toevoegen aan dit blok', 'vtc-training-planner' ),
						'addTeamToSlotTitle' => __( 'Kies team voor gezamenlijke training', 'vtc-training-planner' ),
						'addTeamToSlotEmpty' => __( 'Alle teams zitten al in dit blok.', 'vtc-training-planner' ),
						'coTeamAdded' => __( 'Team toegevoegd aan het blok.', 'vtc-training-planner' ),
						'teamNameJoin' => __( ' + ', 'vtc-training-planner' ),
						...
						'matchReferee' => __( 'Scheidsrechter', 'vtc-training-planner' ),
						'matchScorer' => __( 'Teller', 'vtc-training-planner' ),
